...
function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="relative size-12 transition-all duration-300 hover:bg-background"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
        height="32"
        className="size-9 text-yellow-500 dark:text-green-600"
        strokeWidth="2"
        stroke="currentColor"
        fill="currentColor"
        strokeLinecap="round"
...
export default function Nav() {
  return (
    <nav className="flex items-end justify-end p-2">
      <ThemeToggle />
    </nav>
  );
}
